...
uniq(names, (uniqArr) => {
  console.log(
    `the new names array wiht all the duplicate items removes is ${uniqArr}`
  );
});
...
// CODE HERE
each(names, (indexparam, itemparam) =>
